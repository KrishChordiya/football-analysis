# Overwrite goalkeeper as player. Can't do it with model.tracker
...
class Tracker():
    ...
    def draw_ellispe(self, frame, bbox, color, track_id=None):
        y2 = int(bbox[3])
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                ...
                frame = self.draw_ellispe(frame, player["bbox"], color, track_id)
                if player.get('has_ball', False):
                    frame = self.draw_triangle(frame, player["bbox"], (0, 0, 255))

            for _, referee in referees_dict.items():
                frame = self.draw_ellispe(frame, referee["bbox"], (0, 255, 255))
